...
| [tests/supabase/](tests/supabase/)                                       | ✅ Suite pytest de RLS (29 tests) — requiere `supabase start` (Docker) corriendo localmente; correr con `python3 -m pytest tests/supabase -v`                        |
